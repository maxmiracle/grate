...
namespace NetBase.ColorMath
{
    ...
    public class ColorWeight
    {
        ...
        public ColorWeight(Color color) : this(color, 1)
        {
        ...
        //public static ColorWeightSum operator -(ColorWeight cw1, ColorWeight cw2)
        //{
        //    ColorWeightSum cws_ret = new ColorWeightSum(cw1);
        //    cws_ret.a -= (double)(cw2.Color.A) * cw2.Weight;
        //    cws_ret.r -= (double)(cw2.Color.R) * cw2.Weight;
        //    cws_ret.g -= (double)(cw2.Color.G) * cw2.Weight;
        //    cws_ret.b -= (double)(cw2.Color.B) * cw2.Weight;
        //    cws_ret.weight -= cw2.Weight;
        //    return cws_ret;
        //}
    }


    public class ColorWeightSum : ColorWeight
    {
        double a;
        double r;
        double g;
        ...
        public static new ColorWeightSum BlackNull = new ColorWeightSum(ColorWeight.BlackNull);
